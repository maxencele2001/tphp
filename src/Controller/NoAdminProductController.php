...
class NoAdminProductController extends AbstractController
{
    /**
    ...
    public function index(ProductRepository $repo): Response
    {
        ...
        return $this->render('NoAdminproduct/index.html.twig', [
            'products'=>$products,
    ...
    {
        return $this->render('NoAdminproduct/product.html.twig', [
            'product'=>$product,
        ]);
    }
}
